...
class appProdProjectContainer extends Container
{
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/user');
        ...
        $o->setOptions(array('always_use_default_target_path' => false, 'default_target_path' => '/admin', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
